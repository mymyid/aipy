...
def setEncoderDecoder(VOCAB_SIZE):
    ...
    # Modified line to unpack the output correctly
    enc_outputs, forward_h, forward_c, backward_h, backward_c = Bidirectional(LSTM(256, return_sequences=True, return_state=True, dropout=0.5, recurrent_dropout=0.5))(enc_embedding)
    
    enc_output = enc_outputs  # Assuming you only need the output sequence
